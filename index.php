...
<!-- <script src="https://portal.remotestaff.com.au/portal/accounts_v2/bower_components/moment/min/moment.min.js"></script> -->
...
<div class="col-75">
<div class="container">
    <form action="https://transact.nab.com.au/directpost/authorise" method="post">
    ...
    <div class="row">
        ...
        <input type="hidden" name="EPS_REFERENCEID" id="EPS_REFERENCEID" />
        <input type="hidden" name="EPS_AMOUNT" id="EPS_AMOUNT" value="<?php echo $amount; ?>" />
        <input type="hidden" name="EPS_TIMESTAMP" id="EPS_TIMESTAMP" />
        <input type="hidden" name="EPS_FINGERPRINT" id="EPS_FINGERPRINT" />
         <!-- <input type="hidden" name="EPS_HTML" value="<html> Thank you for your payment! </html>"> -->
        <input
            type="hidden"
            class="EPS_RESULTURL"
            name="EPS_RESULTURL"
...
<script>
    $(document).ready(function () {
        let merchant_id="THN0010";
        let transaction_password="abcd1234"; 
        //   let amt = $('.amt').val();
        let amt= $('#EPS_AMOUNT').val();
        let doc_id = $('.doc_id').val();
        let date = new Date();

        $("#EPS_MERCHANT").val(merchant_id);
        ...
        $.ajax({
            ...
            data: { 
                ...
                $("#EPS_TIMESTAMP").val(result.timestamp);
                $("#EPS_FINGERPRINT").val(result.fingerprint);
