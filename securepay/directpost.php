...
<div class="col-75">
<div class="container">
    <form action="https://test.api.securepay.com.au/directpost/authorise" method="post">
    ...
    <div class="row">
        ...
        <input type="hidden" name="EPS_REFERENCEID" value="<?php echo $order_id; ?>">
        <input type="hidden" name="EPS_AMOUNT" value="100">
        <input type="hidden" name="EPS_CURRENCY" value="<?php echo $currency; ?>">
        <input type="hidden" name="EPS_TIMESTAMP" value="<?php echo date('YmdHis'); ?>">
        <input type="hidden" name="EPS_RESULTURL" value="https://www.remotestaff.com.au/payment/thank-you.php">
        <?php
            $hash = implode('|', [
                'ABC0001',
                'abc123',
        ...
        value="<?php echo sha1($hash); ?>">

        <label for="cname">Name on Card</label>
        <input type="text" name="EPS_FIRSTNAME" placeholder="John">
        <input type="text" name="EPS_LASTNAME" placeholder="Doe">
        <label for="ccnum">Credit card number</label>
        <input type="text" name="EPS_CARDNUMBER" placeholder="1111-2222-3333-4444">
        <label for="expmonth">Exp Month</label>
        <input type="number" name="EPS_EXPIRYMONTH" placeholder="01">
        <div class="row">
            <div class="col-50">
            <label for="expyear">Exp Year</label>
            <input type="number" name="EPS_EXPIRYYEAR" placeholder="2022"> 
            </div>
            <div class="col-50">
            <label for="cvv">CVV</label>
            <input type="number" name="EPS_CCV" placeholder="123">
            </div>
        </div>
        </div>
